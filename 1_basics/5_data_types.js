...
/**
 * String 타입
 * 작은 따옴표나 큰 따옴표 상관 없이 선언이 가능하다.
 * 작은 따옴표를 쓰면 안에다가 큰 따옴표를 넣을 수 있다.
 */
...
const baackSlash = '아이브\\코드팩토리';
console.log(baackSlash);
const samllQutoation = '아이브\'코드팩토리';
console.log(samllQutoation);
...
let init = null;
console.log(init);
console.log(typeof init); //일종의 버그로 object로 나온다
console.log('----------');
